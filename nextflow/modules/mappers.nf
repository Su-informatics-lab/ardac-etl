 ...
 */
 process FOLLOWUP_NODE_MAPPER {
   ...
   output:
      ...
      path("${node_output_path}/follow-up_qc_${subjects_val}.${params.dcc_relese}.tsv"), emit: followup_qc_file
 ...
 */
 process AUDIT_NODE_MAPPER {
   ...
   output:
      path("${node_output_path}/" + mapSubjectsTypeToAuditNodeFile(subjects_type)), emit: audit_node_file
      path("${node_output_path}/" + mapSubjectsTypeToAuditQCFile(subjects_type)), emit: audit_qc_file
